      ...
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 className="mt-6 text-center text-3xl font-extrabold text-white">I want to register</h2>
          </div>
          <form className="mt-8 space-y-6" /* onSubmit={submitHanlder} */>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="/reset" className="font-medium text-indigo-600 hover:text-indigo-800">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-700 hover:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
