...
import yardsale from '../../public/YardSale.jpg'
    ...
    <div>
      <div className="hero min-h-full">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <Image src={yardsale} width={300} className="max-w-sm rounded-lg shadow-2xl" />
          <div>
            <h1 className="text-5xl font-extrabold text-white">Bienvenido!</h1>
            <p className="py-6 mr-16 text-white">Inicie sesion para ingresar en Dashboard ShopSale. <br/> Si no tienes una cuenta, registrate gratis!</p>
